...
if arcpy.CheckExtension("Spatial") == "Available":
    ...
    arcpy.env.workspace = r'C:\Users\dbeene\OneDrive - University of New Mexico\P50_2020-21\10_Resources\01_Git\Landforms\testWorkspace' # Workspace
    DEM = r'\dem' # Define DEM
    arcpy.env.mask = DEM # Set DEM as raster analysis mask
    arcpy.env.extent = DEM
    arcpy.env.cellSize = DEM
    # User input, neighborhood shape and size:
    shape = raw_input("Enter neighborhood shape: ") # Set tkinter dropdown to include ("NbrAnnulus", "NbrCircle", "NbrRectangle")
